...
<body style="margin-top: 30px; background-color: #FFFFFF;">
    ...
    <div class = "container" style= "width: 50%; padding: 30px;">
        <ul class="list-group">
            ...
            <li class="list-group-item" type="" style="font-size: 30px; color: #FFFFFF;"><a style="color: 	#0000FF;" href="ind_toilet.php">Data Toilet</a></li>
             
            <li class="list-group-item" style="font-size: 30px; color: #FFFFFF;"><a style="color: 	#0000FF;" href="index.php">Checklist Toilet</a></li>
