...
<div class="container" style="padding-bottom: 200px">
	<h2 style=" width: 100%; border-bottom: 4px solid hsl(234, 100%, 76%);"><b>Checkout</b></h2>
	<div class="row">
		<div class="col-md-6">
	...
	<h2 class="bg-success text-center" style="padding: 10px;">metode pembayaran</h2>
	<h4 class="text-center" style="font-weight: bold;">Hanya melayani metode pembayaran transfer bank</h4>
<?php  ?>
