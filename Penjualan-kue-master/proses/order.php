...
// Simpan ke database
mysqli_query($conn, "INSERT INTO produksi (nama_produk, tanggal, harga, metode_pembayaran, qty, terima) VALUES ('$nama_produk', '$tanggal', '$harga', '$metode_pembayaran', '$qty', 1)");
